...
plutonium_atomic_rocket.action.action_delivery[1].radius = 17                           -- math.ceil(12 * 1.4)
plutonium_atomic_rocket.action.action_delivery[2].radius = 13                           -- 9 * 1.4 = 12.6
plutonium_atomic_rocket.action.action_delivery[7].damage.amount = 560                   -- 400 * 1.4
plutonium_atomic_rocket.action.action_delivery[10].radius = 20                          -- 14 * 1.4
plutonium_atomic_rocket.action.action_delivery[11].spawn_min_radius = 16.5 -- Rough numbers
plutonium_atomic_rocket.action.action_delivery[11].spawn_max_radius = 17.5
plutonium_atomic_rocket.action.action_delivery[11].spawn_min = 45
plutonium_atomic_rocket.action.action_delivery[11].spawn_max = 60
plutonium_atomic_rocket.action.action_delivery[12].action.repeat_count = 1400           -- 1000 * 1.4
plutonium_atomic_rocket.action.action_delivery[12].action.radius = 10                   -- 7 * 1.4
plutonium_atomic_rocket.action.action_delivery[12].action.action_delivery.starting_speed = 0.5*0.8 * 1.4
plutonium_atomic_rocket.action.action_delivery[13].action.repeat_count = 1400           -- 1000 * 1.4
plutonium_atomic_rocket.action.action_delivery[13].action.radius = 50                   -- 35 * 1.4
plutonium_atomic_rocket.action.action_delivery[13].action.action_delivery.starting_speed = 0.5*0.7 * 1.4
plutonium_atomic_rocket.action.action_delivery[14].action.repeat_count = 1400           -- 1000 * 1.4
plutonium_atomic_rocket.action.action_delivery[14].action.radius = 36                   -- 26 * 1.4
plutonium_atomic_rocket.action.action_delivery[14].action.action_delivery.starting_speed = 0.5*0.7 * 1.4
plutonium_atomic_rocket.action.action_delivery[15].action.repeat_count = 980            -- 700 * 1.4
plutonium_atomic_rocket.action.action_delivery[15].action.radius = 6                    -- 4 * 1.4
plutonium_atomic_rocket.action.action_delivery[15].action.action_delivery.starting_speed = 0.5*0.65 * 1.4
plutonium_atomic_rocket.action.action_delivery[16].action.repeat_count = 1400           -- 1000 * 1.4
plutonium_atomic_rocket.action.action_delivery[16].action.radius = 11                   -- 8 * 1.4
plutonium_atomic_rocket.action.action_delivery[16].action.action_delivery.starting_speed = 0.5*0.65 * 1.4
plutonium_atomic_rocket.action.action_delivery[17].action.repeat_count = 420            -- 300 * 1.4
plutonium_atomic_rocket.action.action_delivery[17].action.radius = 36                   -- 26 * 1.4
plutonium_atomic_rocket.action.action_delivery[17].action.action_delivery.starting_speed = 0.5*0.65 * 1.4
plutonium_atomic_rocket.action.action_delivery[18].action.repeat_count = 14             -- 10 * 1.4
plutonium_atomic_rocket.action.action_delivery[18].action.radius = 11                   -- 8 * 1.4
